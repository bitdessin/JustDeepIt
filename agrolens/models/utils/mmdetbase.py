...
try:
    ...
    raise ImportError('AgroLens requires mmdetection library to build models. Make sure mmdetection has been installed already.')
...
class MMDetBase(ModuleTemplate):
    ...
    def train(self, annotation, image_dpath,
        ...
        if gpu == 0:
            ...
            raise EnvironmentError('The current AgroLens does not support multiple GPUs for trianing.')
