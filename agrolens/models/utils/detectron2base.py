tests/test_modelutils.py import os
import sys
import json
import glob
import tqdm
...
try:
    ...
    raise ImportError('AgroLens requires detectron2 library to build models. Make sure detectron2 has been installed already.')
