...
class ImageAnnotation:
    ...
    Class :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>` is a container that stores image annotations such as file paths,
    ...
    Class :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>` mainly implements methods
    :func:`format <agrolens.utils.ImageAnnotation.format>`
    and :func:`draw <agrolens.utils.ImageAnnotation.draw>`
    for format conversion and image visualization, respectively.
    By using method :func:`format <agrolens.utils.ImageAnnotation.format>`,
    the annotations can be converted to any format,
    such as the COCO format and Pascal VOC format.
    By using method :func:`draw <agrolens.utils.ImageAnnotation.draw>`,
    ...
    def format(self, annotation_format, file_path=None):
        ...
        Method :func:`format <agrolens.utils.ImageAnnotation.format>` converts
        class object :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>`
        into a specific format.
        COCO (:file:`.json`) and Pascal VOC (:file:`.xml`)
        are supported formats in the current version of AgroLens.
        Additionally, this method supports the conversion of class object
        :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>`
...
'''
    ...
    def draw(self, fig_type='mask', file_path=None, label=False, score=False, alpha=1.0, class2rgb=None):
        ...
        Examples:
            ...
            >>> ann_fpath = './path/to/image.json'
            >>> 
            >>> ann = agrolens.utils.ImageAnnotation(image_fpath, ann_fpath)
            >>>
            >>> ann.draw('bbox')
...
class ImageAnnotations:
    """List of :class:`ImageAnnocation <agrolens.utils.ImageAnnotation>` objects
    
    :class:`ImageAnnotations <agrolens.utils.ImageAnnotations>` stores
    :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>` class objects as a list object.
    To retrieve elements from an :class:`ImageAnnotations <agrolens.utils.ImageAnnotationss>` object,
    indexing ``[i]`` and a ``for`` loop can be used.
    To add new elements to the end of :class:`ImageAnnotations <agrolens.utils.ImageAnnotations>`,
    methods :func:`append <agrolens.utils.ImageAnnotations.append>`
    and :func:`extend <agrolens.utils.ImageAnnotations.extend>` can be used.
    In addition, this class implements method :func:`format <agrolens.utils.ImageAnnotations.format>`
    to convert annotations into files in a specific format,
    such as COCO or Pascal VOC.
    Compared with :func:`format <agrolens.utils.ImageAnnotation.format>` implemented in
    class :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>`
    that generates annotations in a specific format for a single image,
    :class:`format <agrolens.utils.ImageAnnotations.format>` in this class
    can generate annotations for multiple images.

    Args:
        x: If ``x`` is ``None``, generate an empty
           :class:`ImageAnnocations <agrolens.utils.ImageAnnotations>` object.
           If ``x`` is :class:`ImageAnnocation <agrolens.utils.ImageAnnotation>`
           or :class:`ImageAnnocations <agrolens.utils.ImageAnnotations>` object,
           convert them to :class:`ImageAnnocations <agrolens.utils.ImageAnnotations>` object.
    ...
    Examples:
        ...
        >>> ann = agrolens.utils.ImageAnnotations([ann_1, ann_2, ann_3])
    """
    ...
    def append(self, image_annotation):
        """Add an :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>` object to the end of the :class:`ImageAnnotations <agrolens.utils.ImageAnnotations>` object
        
        Add an :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>` object
        to the end of the :class:`ImageAnnotations <agrolens.utils.ImageAnnotations>` object.
        
        Args:
            image_annotation (ImageAnnotation): An :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>` object.
    ...
    def extend(self, image_annotations):
        """Concatenate :class:`ImageAnnotations <agrolens.utils.ImageAnnotations>` object to the end of the :class:`ImageAnnotations <agrolens.utils.ImageAnnotations>` object
        
        Concatenate :class:`ImageAnnotations <agrolens.utils.ImageAnnotations>` object
        or a list of :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>` objects
        to the end of the :class:`ImageAnnotations <agrolens.utils.ImageAnnotations>` object.
        
        Args:
            image_annotations (ImageAnnotations, list): An :class:`ImageAnnotations <agrolens.utils.ImageAnnotations>`
                                    object or a list of
                                    :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>` objects.
    ...
    def format(self, annotation_format, file_path=None, dataset_name='dataset'):
        ...
        Rearrange :class:`ImageAnnotations <agrolens.utils.ImageAnnotations>` object
        to a specific format.
        COCO (.json) and Pascal VOC (.xml) are supported in current version.
        Different to :func:`format <agrolens.utils.ImageAnnotation.format>`
        implemented in :class:`ImageAnnotation <agrolens.utils.ImageAnnotation>`,
