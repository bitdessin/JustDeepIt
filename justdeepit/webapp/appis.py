...
class IS(OD):
    ...
    def train_model(self, class_label=None, model_arch='maskrcnn', model_config=None, model_weight=None, 
        ...
        return super().train_model(class_label, model_arch, model_config, model_weight, 
                            batchsize, epoch, lr, score_cutoff, cpu, gpu, backend)
    
    
    def detect_objects(self, class_label=None, model_arch='maskrcnn', model_config=None, model_weight=None,
                       score_cutoff=0.7, batchsize=32, cpu=8, gpu=1, backend='mmdetection'):
        return super().detect_objects(class_label, model_arch, model_config, model_weight,
