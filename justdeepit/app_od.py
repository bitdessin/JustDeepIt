...
class OD(justdeepit.app.AppBase):
    ...
    def detect_objects(self, class_label=None, model_arch='fasterrcnn', model_config=None, model_weight=None,
        ...
        def __save_outputs(ws, image_fpath, output):
            ...
            output.draw('bbox', os.path.join(ws, 'justdeepit/outputs', image_name + '.outline.png'), label=True, score=True)
        ...
        try:
            ...
            for image in self.images:
                images_meta.append([image,
                                    #os.path.join(self.workspace_, 'detection_results', os.path.splitext(os.path.basename(image))[0] + '.xml'),
